...
board(); if (i == 1)
printf("==>\aPlayer %d WINS ", --player); else
printf("==>\aGame DRAW"); return 0;
}


/*************** FUNCTION TO RETURN GAME STATUS
1 FOR GAME IS OVER WITH RESULT -1 FOR GAME IS IN PROGRESS
...
printf(" %c | %c | %c \n", square[1], square[2], square[3]); printf("__|_|__\n");
printf("	|	|	\n");
printf(" %c | %c | %c \n", square[4], square[5], square[6]); printf("__|_|__\n");
printf("	|	|	\n");
